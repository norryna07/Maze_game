...
void Menu::load(sf::RenderWindow &window, const std::string& fontFile, const sf::Color &textColor,
    ...
    buttons.emplace_back("Resume Last Game", font, sf::Vector2f {start_pos.x, start_pos.y + 50}, onClick_functions[0], textColor, buttonColor);
    buttons.emplace_back("Game Story", font, sf::Vector2f {start_pos.x, start_pos.y + 100}, onClick_functions[0], textColor, buttonColor);
    buttons.emplace_back("Exit", font, sf::Vector2f {start_pos.x, start_pos.y + 150}, onClick_functions[0], textColor, buttonColor);
}
